...
const ModalFilterMasterIntern = ({ visible, toggle, dataSBU, sessionData }) => {
              ...
              <>
                <ModalBody>
                  ...
                  <Row>
                    <Col sm="6">
                      <FormGroup className="custom-input-select" md="6">
                        <Label className="form-label">Internship Period</Label>
                        <Input
                          type="text"
                          placeholder="School/College"
                          name="roleName"
...
export default ModalFilterMasterIntern;
