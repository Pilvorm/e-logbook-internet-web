...
const env = `default-src ${process.env.NEXT_PUBLIC_API_MY_TASK} localhost:8081 ws://localhost:8081/ blob: https://m-one.kalbe.co.id:8243/t/ fonts.googleapis.com fonts.gstatic.com 'unsafe-eval'; style-src 'self' fonts.googleapis.com 'unsafe-inline'; style-src-elem 'unsafe-inline' fonts.googleapis.com 'self'; font-src 'self' data: fonts.gstatic.com; img-src * blob: data:; frame-src youtube.com https://www.youtube.com;`;

const envNEW = `default-src ${process.env.NEXT_PUBLIC_API_MY_TASK} localhost:8081 ws://localhost:8081/ blob: fonts.googleapis.com fonts.gstatic.com 'unsafe-eval'; style-src 'self' fonts.googleapis.com 'unsafe-inline'; style-src-elem 'unsafe-inline' fonts.googleapis.com 'self'; font-src 'self' data: fonts.gstatic.com; img-src * blob: data:; frame-src youtube.com https://www.youtube.com;`;
